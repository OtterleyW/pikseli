<?
$stmt = $db->prepare('SELECT * FROM hevonen_tiedot WHERE kasvattaja = "Hukkapuro" AND YEAR(syntymaaika) = "2016" ORDER BY syntymaaika DESC');
$stmt->execute();
$kasvatit16 = $stmt->fetchAll();
?>

<h3>Vuoden 2016 kasvatit</h3>

<p>Kasvatteja syntynyt <?= count($kasvatit16)?>.</p>
</div>
</div>

<div class="row content">
	<?
	foreach ($kasvatit16 as $hevonen) {
