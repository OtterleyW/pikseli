<?
$stmt = $db->prepare('SELECT * FROM hevonen_tiedot WHERE kasvattaja = "Hukkapuro" AND YEAR(syntymaaika) = "2018" ORDER BY syntymaaika DESC');
$stmt->execute();
$kasvatit18 = $stmt->fetchAll();
?>

<h3>Vuoden 2018 kasvatit</h3>

<p>Kasvatteja syntynyt <?= count($kasvatit18)?>.</p>
</div>
</div>

<div class="row content">
	<?
	foreach ($kasvatit18 as $hevonen) {
