...
$top_yksinkertaisempi_ylapalkki = true;
require('top.php');
?>
...
<div class="row sisalto">
	<div class="large-12 columns">
		<div class="row">
			<div class="large-12 columns">
				<h2>Interaktiivinen sukutaulu</h2>


				<p>Klikkaa sukulaista päästäksesi tarkastelemaan sukua kyseisestä hevosesta eteenpäin. Takaisin edelliseen hevoseen pääset selaimen edellinen-näppäimellä.</p>
			</div>
		</div>
