<?
$stmt = $db->prepare('SELECT * FROM hevonen_tiedot WHERE kasvattaja = "Hukkapuro" AND YEAR(syntymaaika) = "2017" ORDER BY syntymaaika DESC');
$stmt->execute();
$kasvatit17 = $stmt->fetchAll();
?>

<h3>Vuoden 2017 kasvatit</h3>

<p>Kasvatteja syntynyt <?= count($kasvatit17)?>.</p>
</div>
</div>

<div class="row content">
	<?
	foreach ($kasvatit17 as $hevonen) {
