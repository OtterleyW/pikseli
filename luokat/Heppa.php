...
class Heppa {
	...
	function __construct($tiedot = null, $suku = null) {
		...
		$this->muut_kilpailut = $tiedot['muut_kilpailut'];
		$this->kaappi = $tiedot['kaappi'];
	...
	function hae_url() {
		if ($this->omistaja == 'Wolf Sporthorses, VRL-12757') {
			return '/wolf/' . $this->slug;
		} elseif ($this->omistaja == 'Otterley Wilson VRL-12757') {
			return '/hukkapuro/' . $this->slug;
		} elseif($this->omistaja == 'Otterley VRL-12757') {
			return '/yksityiset' . $this->slug;
		}
		return $this->url;
	}
