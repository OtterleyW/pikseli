<?
$stmt = $db->prepare('SELECT * FROM hevonen_tiedot WHERE kasvattaja = "Hukkapuro" AND YEAR(syntymaaika) = "2015" ORDER BY syntymaaika DESC');
$stmt->execute();
$kasvatit15 = $stmt->fetchAll();
?>

<h3>Vuoden 2015 kasvatit</h3>

<p>Kasvatteja syntynyt <?= count($kasvatit15)?>.</p>
</div>
</div>

<div class="row content">
	<?
	foreach ($kasvatit15 as $hevonen) {
